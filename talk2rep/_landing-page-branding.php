<?php
/**
 * Template Name: Landing Page | Branding
 * @site talk2rep
 */
get_header();
 ?>
...
<!-- /landing page content -->
 ...
 <div class="col-lg-3 col-md-3 col-xs-12 contact-awards-container">
 <!-- Awards -->
 <div class="col-lg-12 col-md-12 col-xs-6 award-content">
 ...
 <!-- End Award -->
   ...
   <!-- Awards -->
   <div class="col-lg-12 col-md-12 col-xs-6 award-content md-margin-top">
